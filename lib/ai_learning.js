...
export function parseAiJson(text) {
    ...
    const hasTrigger = triggerTags.some((item) => item && !/^(unclear|none|not[_ ]visible|unknown)$/.test(item));
    const hasConfirmation = Boolean(confirmation && !/(unclear|none|not[_ ]visible|not explicitly visible|unknown)/.test(confirmation));
