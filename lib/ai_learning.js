...
export function parseAiJson(text) {
    ...
    const visibleEntryMarker = /(entry|position|execution|buy|sell)\s+(marker|arrow|line)|marker\s+(at|near)|в(?:х|x)ід\w*\s+(маркер|стріл|ліні)|стріл\w*\s+в(?:х|x)оду/i.test(visibleText);
