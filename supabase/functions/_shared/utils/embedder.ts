...
export function buildUnifiedEmbeddingText({ baseText = '', trade = {}, multimodal = null } = {}) {
    ...
    return [
        ...
        line('Discipline grade', trade?.disciplineGrade),
        line('Discipline score', trade?.disciplineScore),
        line('Discipline evidence', Array.isArray(trade?.disciplineReasons) ? trade.disciplineReasons.join('; ') : trade?.disciplineReasons),
