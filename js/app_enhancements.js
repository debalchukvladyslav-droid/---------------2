...
function activateAction(action, trigger, event = null) {
    ...
    const actions = {
        ...
        'analytics-export-open': () => window.openAnalyticsExport?.(),
        'analytics-export-close': () => window.closeAnalyticsExport?.(),
        'analytics-export-next': () => window.analyticsExportNext?.(),
        'analytics-export-prev': () => window.analyticsExportPrev?.(),
        'analytics-period-add': () => window.addAnalyticsReportPeriod?.(),
        'analytics-export-reset': () => window.resetAnalyticsExport?.(),
        ...
        'ai-paper-run': () => window.runAIPaperDecision?.(),
        'ai-learning-new': () => window.startNewAILearning?.(),
        'ai-learning-continue': () => window.continueAILearning?.(),
        'ai-learning-evaluate': () => window.evaluateAILearning?.(),
        ...
        'session-modal-open': () => window.openSessionModalManual?.(),
