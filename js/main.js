...
import { initAILearningCenter, renderAILearningCenter, runAILearning, startNewAILearning, toggleAILearningDay, reviewAILearningExample } from './ai_learning.js';
...
window.toggleAILearningDay = toggleAILearningDay;
...
window.openAnalyticsExport = openAnalyticsExport;
window.closeAnalyticsExport = closeAnalyticsExport;
window.analyticsExportNext = analyticsExportNext;
window.analyticsExportPrev = analyticsExportPrev;
window.addAnalyticsReportPeriod = addAnalyticsReportPeriod;
window.resetAnalyticsExport = resetAnalyticsExport;
window.saveAnalyticsExportPreset = saveAnalyticsExportPreset;
window.loadAnalyticsExportPreset = loadAnalyticsExportPreset;
...
window.initStopReview = initStopReview;
window.refreshStopReview = refreshStopReview;
...
window.openCumulativeWeekly = openCumulativeWeekly;
window.closeCumulativeWeekly = closeCumulativeWeekly;
window.toggleCumulativeDayloss = toggleCumulativeDayloss;
window.saveCumulativeDayloss = saveCumulativeDayloss;
