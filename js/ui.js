...
const THEME_PRESETS = {
    ...
    ocean: {
        background: '#07111f', card: '#101a33', primary: '#60a5fa', primaryForeground: '#07111f',
        muted: '#182848', mutedForeground: '#93b4d8', border: '#24365c', ring: '#60a5fa',
        sidebarBg: '#060e1c', sidebarAccentBg: '#152445', bgColor: '#07111f', panelColor: '#101a33',
        primaryColor: '#60a5fa', textPrimary: '#e8f1ff', textSecondary: '#93b4d8', bgHover: '#1a2d52',
        accentHover: '#93c5fd', profit: '#34d399', loss: '#fb7185', gold: '#fbbf24',
        aiBg: 'rgba(96,165,250,0.07)', aiBorder: 'rgba(96,165,250,0.3)',
    },
    nord: {
    ...
    sunset: {
        background: '#1c1208', card: '#2c1b0e', primary: '#f5b942', primaryForeground: '#1c1208',
        muted: '#3d2814', mutedForeground: '#c4a27a', border: '#5a3b1c', ring: '#f5b942',
        sidebarBg: '#160e06', sidebarAccentBg: '#2a1a0c', bgColor: '#1c1208', panelColor: '#2c1b0e',
        primaryColor: '#f5b942', textPrimary: '#fff6e8', textSecondary: '#c4a27a', bgHover: '#3f2912',
        accentHover: '#fcd34d', profit: '#4ade80', loss: '#f43f5e', gold: '#fde68a',
        aiBg: 'rgba(245,185,66,0.07)', aiBorder: 'rgba(245,185,66,0.28)',
    },
    rose: {
        background: '#160818', card: '#2a102c', primary: '#e879f9', primaryForeground: '#160818',
        muted: '#3b1640', mutedForeground: '#c9a0d4', border: '#54225c', ring: '#e879f9',
        sidebarBg: '#120614', sidebarAccentBg: '#2d1232', bgColor: '#160818', panelColor: '#2a102c',
        primaryColor: '#e879f9', textPrimary: '#fdf4ff', textSecondary: '#c9a0d4', bgHover: '#3d1844',
        accentHover: '#f0abfc', profit: '#34d399', loss: '#fb7185', gold: '#fbbf24',
        aiBg: 'rgba(232,121,249,0.07)', aiBorder: 'rgba(232,121,249,0.28)',
    },
    obsidian: {
    ...
    lagoon: {
        background: '#04211c', card: '#0c332c', primary: '#2ee6a6', primaryForeground: '#04211c',
        muted: '#13493c', mutedForeground: '#8fceba', border: '#1c5c4c', ring: '#2ee6a6',
        sidebarBg: '#031a16', sidebarAccentBg: '#0e3b32', bgColor: '#04211c', panelColor: '#0c332c',
        primaryColor: '#2ee6a6', textPrimary: '#ecfff6', textSecondary: '#8fceba', bgHover: '#145445',
        accentHover: '#6ef3c2', profit: '#4ade80', loss: '#fb7185', gold: '#facc15',
        aiBg: 'rgba(46,230,166,0.07)', aiBorder: 'rgba(46,230,166,0.28)',
    },
    ember: {
        background: '#1a0b07', card: '#2e140e', primary: '#ff6a3d', primaryForeground: '#1a0b07',
        muted: '#4a2218', mutedForeground: '#d2a08e', border: '#6a3122', ring: '#ff6a3d',
        sidebarBg: '#140806', sidebarAccentBg: '#3a1810', bgColor: '#1a0b07', panelColor: '#2e140e',
        primaryColor: '#ff6a3d', textPrimary: '#fff4ee', textSecondary: '#d2a08e', bgHover: '#4e2418',
        accentHover: '#ff8f6b', profit: '#4ade80', loss: '#ff4d6d', gold: '#fbbf24',
        aiBg: 'rgba(255,106,61,0.08)', aiBorder: 'rgba(255,106,61,0.3)',
    },
    frost: {
...
async function runMainTabWork(tab) {
    ...
    // The restore-point list is a network call. It must not hold the settings loader.
    if (tab === 'settings' && window.refreshSettingsBackups) {
        void Promise.resolve(window.refreshSettingsBackups()).catch((error) => {
            console.warn('[Settings backups]', error?.message || error);
        });
    }
