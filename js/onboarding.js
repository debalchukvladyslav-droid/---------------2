...
const steps = [
    ...
    { id: 'drive-share', tab: 'screens', target: '#drive-service-email', title: '2. Надайте доступ до папки', text: 'Скопіюйте цю service account пошту та додайте її до папки Google Drive з правами «Редактор».', group: 'drive', prepare: 'screens-open', optional: true },
