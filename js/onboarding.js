...
const steps = [
    ...
    { id: 'sheet-source', tab: 'table', target: ['.sheet-preset-picker:not(.sheet-preset-picker--workspace)', '#sheet-tab-picker'], title: '1. Оберіть таблицю статистики', text: 'Спочатку підключіть свою таблицю статистики. Якщо в ній кілька аркушів, виберіть потрібний аркуш у списку.', group: 'mapping', prepare: 'sheet-open', optional: true },
